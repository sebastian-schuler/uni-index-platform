...
import { getInstitutionByUser, getSubjectsByInstitute, getUserFromToken } from '../../../lib/prisma/prismaUserAccounts';
    ...
    if (userData === null) {
        ...
        if (validUntil > now) {
            ...
            if (req.query.profile === "true") {
                ...
                const profile: UserDataProfile = { user: userData.user, institution: institutionResult?.institution || undefined };
