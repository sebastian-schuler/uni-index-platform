...
const AccessibilityPage = ({ institution, country, lhrAudits, lhrCategory, footerContent }: Props) => {
    ...
    return (
        <>
            <Head>
                <title key={"title"}>{t('common:page-title') + " | " + t('online-marketing.meta.accessibility-title', { institution: institution?.name })}</title>
                <meta key={"description"} name="description" content={t('online-marketing.meta.accessibility-title')} />
            </Head>
